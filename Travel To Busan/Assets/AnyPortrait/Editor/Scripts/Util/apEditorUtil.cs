...
namespace AnyPortrait
{
	...
	public static class apEditorUtil
	{
		...
		public static void GUI_DelimeterBoxV(int height)
		{
			...
			GUILayout.Box(Text_EMPTY, apGUILOFactory.I.Width(4), apGUILOFactory.I.Height(height));
		...
		public static void GUI_DelimeterBoxH(int width)
		{
			...
			GUILayout.Box(Text_EMPTY, apGUILOFactory.I.Width(width), apGUILOFactory.I.Height(4));
			GUI.backgroundColor = prevColor;
		}
