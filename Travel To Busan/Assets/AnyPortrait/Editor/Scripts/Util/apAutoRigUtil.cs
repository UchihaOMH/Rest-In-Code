	...
	public static class apAutoRigUtil
	{
		...
		public class EnvelopeInfo
		{
			...
			public EnvelopeInfo(apBone bone)
			{
				...
				_posStart = _bone._worldMatrix_NonModified._pos;
				...
				if (!_isHelper)
				{
					...
					for (int iBone = 0; iBone < linkedBones.Count; iBone++)
					{
						...
						linkedPosStart = linkedBone._worldMatrix_NonModified._pos;
		...
		{
			Vector2 posBoneStart = bone._worldMatrix_NonModified._pos;
