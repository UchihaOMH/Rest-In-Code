...
namespace AnyPortrait
{
	...
	public class apBackupTable
	{
		...
		private Dictionary<string, Type> _parsedTypes = new Dictionary<string, Type>();
		...
		public Type GetTypeParsed(int index)
		{
			...
			_parsedTypes.Add(typeName, Type.GetType(typeName));
			return _parsedTypes[typeName];
		}
